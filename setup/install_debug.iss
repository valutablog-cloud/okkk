...
OutputBaseFilename=tuxlerVPNSetupDebug
...
;Source: "..\debug\vcredist_x86.exe"; DestDir: {tmp}; Flags: deleteafterinstall;             
Source: "..\debug\*.dll"; DestDir: "{app}";   Flags:  overwritereadonly ignoreversion;   
Source: "..\debug\tuxlerVPN.exe"; DestDir: "{app}";   Flags:  overwritereadonly ignoreversion; 
Source: "..\debug\TuxlerAppWatcher.exe"; DestDir: "{app}";   Flags:  overwritereadonly ignoreversion; 
Source: "..\debug\platforms\*.dll"; DestDir: "{app}\platforms";   Flags:  overwritereadonly ignoreversion;
Source: "..\debug\imageformats\*.dll"; DestDir: "{app}\imageformats";   Flags:  overwritereadonly ignoreversion;  
Source: "..\debug\bearer\*.dll"; DestDir: "{app}\bearer";   Flags:  overwritereadonly ignoreversion;
Source: "..\debug\sensors\*.dll"; DestDir: "{app}\sensors";   Flags:  overwritereadonly ignoreversion;  
Source: "..\build\license.txt"; DestDir: "{app}";   Flags:  overwritereadonly ignoreversion;     
;Source: "..\debug\privoxy\*"; DestDir: "{app}\privoxy";   Flags:  overwritereadonly ignoreversion recursesubdirs;    
...
begin
	...
	begin
		...
		AddFirewallException('tuxlerVPN Helper', ExpandConstant('{app}\TuxlerAppWatcher.exe'));
	end;
...
begin
	...
	begin
		...
		RemoveFirewallException('tuxlerVPN Helper', ExpandConstant('{app}\TuxlerAppWatcher.exe'));
    countUnInstall();
	end;
end;
...
Exec(ExpandConstant('{sys}\taskkill.exe'),'/f /im TuxlerAppWatcher.exe','',SW_HIDE,ewWaitUntilTerminated,ErrorCode);
while zylIsAppRunning('TuxlerAppWatcher.exe', false) do Sleep(1000);
