...
WelcomeLabel2=Tuxler will allow you to:%n%n- change IP instantly to any location you wish%n- protect your privacy when surfing online%n- access content that is not available in your country of %n  residence%n%nHow it works:%n%nTuxler allows you to hide your real IP and connect to internet through IP addresses available in our network.%nPlease be aware that if you are using Free version other members of our network may connect through your%nIP to the internet when Tuxler application is running.%nPlease upgrade to Premium to enjoy full benefits of Tuxler%nwithout sharing your IP in our network.
